...
::
    ...
    odoo_install_repository OCB -b 8.0 -O oia
...
.. |Maturity| image:: https://img.shields.io/badge/maturity-Alfa-red.png
    ...
    :alt: Alfa
.. |Build Status| image:: https://travis-ci.org/Odoo-Italia-Associazione/OCB.svg?branch=8.0
    :target: https://travis-ci.org/Odoo-Italia-Associazione/OCB
    :alt: github.com
.. |license gpl| image:: https://img.shields.io/badge/licence-AGPL--3-blue.svg
    :target: http://www.gnu.org/licenses/agpl-3.0-standalone.html
    :alt: License: AGPL-3
.. |Coverage Status| image:: https://coveralls.io/repos/github/Odoo-Italia-Associazione/OCB/badge.svg?branch=8.0
    :target: https://coveralls.io/github/Odoo-Italia-Associazione/OCB?branch=8.0
    :alt: Coverage
.. |Codecov Status| image:: https://codecov.io/gh/Odoo-Italia-Associazione/OCB/branch/8.0/graph/badge.svg
    :target: https://codecov.io/gh/Odoo-Italia-Associazione/OCB/branch/8.0
    :alt: Codecov
