...
.. |icon| image:: https://raw.githubusercontent.com/Odoo-Italia-Associazione/oia11/11.0/account_invoice_entry_date/static/description/icon.png
...
+---------------------------------+------------------------------------------+
| /opt/odoo/11.0/oia11/account_invoice_entry_date                               |
+----------------------------------------------------------------------------+
...
``run_odoo_debug 11.0 -um account_invoice_entry_date -s -d MYDB``
