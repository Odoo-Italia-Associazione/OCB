...
.. |icon| image:: https://raw.githubusercontent.com/Odoo-Italia-Associazione/oia11/11.0/l10n_it_fatturapa_out/static/description/icon.png
...
+---------------------------------+------------------------------------------+
| /opt/odoo/11.0/oia11/l10n_it_fatturapa_out                               |
+----------------------------------------------------------------------------+
...
``run_odoo_debug 11.0 -um l10n_it_fatturapa_out -s -d MYDB``
