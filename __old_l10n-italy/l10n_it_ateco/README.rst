...
.. |icon| image:: https://raw.githubusercontent.com/Odoo-Italia-Associazione/__old_l10n-italy/10.0/l10n_it_ateco/static/description/icon.png
...
+---------------------------------+------------------------------------------+
| /opt/odoo/10.0/__old_l10n-italy/l10n_it_ateco                               |
+----------------------------------------------------------------------------+
...
|menu| Setting > Apps |right_do| Select **l10n_it_ateco** > Install

|warning| If your Odoo instance crashes, you can do following instruction
to recover installation status:

``run_odoo_debug 10.0 -um l10n_it_ateco -s -d MYDB``
