...
.. |icon| image:: https://raw.githubusercontent.com/Odoo-Italia-Associazione/__old_l10n-italy/10.0/l10n_it_rea/static/description/icon.png
...
+---------------------------------+------------------------------------------+
| /opt/odoo/10.0/__old_l10n-italy/l10n_it_rea                               |
+----------------------------------------------------------------------------+
...
``run_odoo_debug 10.0 -um l10n_it_rea -s -d MYDB``
