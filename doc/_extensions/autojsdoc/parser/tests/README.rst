...
.. |icon| image:: https://raw.githubusercontent.com/Odoo-Italia-Associazione/parser/11.0/tests/static/description/icon.png
...
::
    ...
    odoo_install_repository parser -b 11.0 -O oia
...
<https://github.com/Odoo-Italia-Associazione/parser/issues>`_.
...
.. |Maturity| image:: https://img.shields.io/badge/maturity-Alfa-red.png
    ...
    :alt: Alfa
.. |Build Status| image:: https://travis-ci.org/Odoo-Italia-Associazione/parser.svg?branch=11.0
    :target: https://travis-ci.org/Odoo-Italia-Associazione/parser
    :alt: github.com
.. |license gpl| image:: https://img.shields.io/badge/licence-LGPL--3-7379c3.svg
    :target: http://www.gnu.org/licenses/lgpl-3.0-standalone.html
    :alt: License: LGPL-3
.. |Coverage Status| image:: https://coveralls.io/repos/github/Odoo-Italia-Associazione/parser/badge.svg?branch=11.0
    :target: https://coveralls.io/github/Odoo-Italia-Associazione/parser?branch=11.0
    :alt: Coverage
.. |Codecov Status| image:: https://codecov.io/gh/Odoo-Italia-Associazione/parser/branch/11.0/graph/badge.svg
    :target: https://codecov.io/gh/Odoo-Italia-Associazione/parser/branch/11.0
    :alt: Codecov
.. |OCA project| image:: https://www.zeroincombenze.it/wp-content/uploads/ci-ct/prd/button-oca-11.svg
    :target: https://github.com/OCA/parser/tree/11.0
    :alt: OCA
