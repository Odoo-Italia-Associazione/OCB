...
.. |icon| image:: https://raw.githubusercontent.com/Odoo-Italia-Associazione/oia9/9.0/l10n_it_abicab/static/description/icon.png
...
+---------------------------------+------------------------------------------+
| /opt/odoo/9.0/oia9/l10n_it_abicab                               |
+----------------------------------------------------------------------------+
...
``run_odoo_debug 9.0 -um l10n_it_abicab -s -d MYDB``
