...
.. |icon| image:: https://raw.githubusercontent.com/Odoo-Italia-Associazione/oia11/11.0/l10n_it_fatturapa/static/description/icon.png
...
+---------------------------------+------------------------------------------+
| /opt/odoo/11.0/oia11/l10n_it_fatturapa                               |
+----------------------------------------------------------------------------+
...
|menu| Setting > Apps |right_do| Select **l10n_it_fatturapa** > Install

|warning| If your Odoo instance crashes, you can do following instruction
to recover installation status:

``run_odoo_debug 11.0 -um l10n_it_fatturapa -s -d MYDB``
