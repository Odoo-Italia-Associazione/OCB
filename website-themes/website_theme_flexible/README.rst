...
.. |icon| image:: https://raw.githubusercontent.com/Odoo-Italia-Associazione/website-themes/11.0/website_theme_flexible/static/description/icon.png
...
+---------------------------------+------------------------------------------+
| /opt/odoo/11.0/website-themes/website_theme_flexible                               |
+----------------------------------------------------------------------------+
...
::
    ...
    odoo_install_repository website-themes -b 11.0 -O oia
...
|menu| Setting > Apps |right_do| Select **website_theme_flexible** > Install

|warning| If your Odoo instance crashes, you can do following instruction
to recover installation status:

``run_odoo_debug 11.0 -um website_theme_flexible -s -d MYDB``
...
<https://github.com/Odoo-Italia-Associazione/website-themes/issues>`_.
...
.. |Maturity| image:: https://img.shields.io/badge/maturity-Alfa-red.png
    ...
    :alt: Alfa
.. |Build Status| image:: https://travis-ci.org/Odoo-Italia-Associazione/website-themes.svg?branch=11.0
    :target: https://travis-ci.org/Odoo-Italia-Associazione/website-themes
    :alt: github.com
.. |license gpl| image:: https://img.shields.io/badge/licence-LGPL--3-7379c3.svg
    :target: http://www.gnu.org/licenses/lgpl-3.0-standalone.html
    :alt: License: LGPL-3
.. |Coverage Status| image:: https://coveralls.io/repos/github/Odoo-Italia-Associazione/website-themes/badge.svg?branch=11.0
    :target: https://coveralls.io/github/Odoo-Italia-Associazione/website-themes?branch=11.0
    :alt: Coverage
.. |Codecov Status| image:: https://codecov.io/gh/Odoo-Italia-Associazione/website-themes/branch/11.0/graph/badge.svg
    :target: https://codecov.io/gh/Odoo-Italia-Associazione/website-themes/branch/11.0
    :alt: Codecov
.. |OCA project| image:: https://www.zeroincombenze.it/wp-content/uploads/ci-ct/prd/button-oca-11.svg
    :target: https://github.com/OCA/website-themes/tree/11.0
    :alt: OCA
