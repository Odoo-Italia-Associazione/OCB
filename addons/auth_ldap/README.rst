...
.. |icon| image:: https://raw.githubusercontent.com/Odoo-Italia-Associazione/addons/8.0/auth_ldap/static/description/icon.png
...
``run_odoo_debug 8.0 -um auth_ldap -s -d MYDB``
