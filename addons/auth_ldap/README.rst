...
.. |icon| image:: https://raw.githubusercontent.com/Odoo-Italia-Associazione/addons/11.0/auth_ldap/static/description/icon.png
...
+---------------------------------+------------------------------------------+
| /opt/odoo/11.0/addons/auth_ldap                               |
+----------------------------------------------------------------------------+
...
``run_odoo_debug 11.0 -um auth_ldap -s -d MYDB``
