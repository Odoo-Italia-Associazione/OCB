...
.. |icon| image:: https://raw.githubusercontent.com/Odoo-Italia-Associazione/addons/9.0/l10n_fr_fec/static/description/icon.png
...
+---------------------------------+------------------------------------------+
| /opt/odoo/9.0/addons/l10n_fr_fec                               |
+----------------------------------------------------------------------------+
...
|menu| Setting > Local Modules |right_do| Select **l10n_fr_fec** > Install

|warning| If your Odoo instance crashes, you can do following instruction
to recover installation status:

``run_odoo_debug 9.0 -um l10n_fr_fec -s -d MYDB``
